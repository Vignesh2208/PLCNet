 ...
 * George
 *
 * $Id: subdomains.c,v 1.1.1.1 2004/07/21 21:01:31 jasonliu Exp $
 *
 */
...
{
  int i, ii, j, jj, k, me=0, nvtxs, tvwgt, first, last, nleft, ncmps, cwgt, /*other,*/ target, deltawgt;
