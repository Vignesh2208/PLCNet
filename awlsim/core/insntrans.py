...
class AwlInsnTranslator(object):
	...
	@classmethod
	# -- creates an insn object from a registered instruction class given the cpu and rawinstruction.
	# -- Extracts instruction type using cpu Mnemonics and raw instruction name
	# -- Uses instruction type to extract instruction class.
	# -- Uses the instruction class to instantiate an instruction object.
